        ...
        <div v-if="!DentistryInfoToggle" class="md:w-[40%] flex flex-col justify-between">
            <div class="bg-white flex flex-col px-5 py-7 space-y-6">
                ...
                <div class="flex w-full items-center gap-10 ">
                    <!-- Adjusted search input container -->
                ...
                <div class="flex justify-between">
                    <button @click="usingCurrentLocation = true" type="button"
...
// create a variable that has SearchInput type, and is a ref, dont use time as a variable name
